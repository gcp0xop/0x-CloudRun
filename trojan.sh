...
tg_send(){
  ...
  for _cid in "${CHAT_ID_ARR[@]}"; do
    # Sending using curl with explicit error checking
    # NOTE: URL encoding happens automatically with --data-urlencode
...
<b>1️⃣ Trojan WS:</b>
<pre><code>${TG_URI_TROJAN}</code></pre>
